# 📊 Odoo 12 – Laporan Mutasi Hutang Vendor (Excel)

Laporan ini dibuat menggunakan Odoo 12 dan berfungsi untuk menampilkan **mutasi hutang supplier/vendor** dalam periode tertentu dalam format **Excel (.xlsx)**.

---

## 📌 Tujuan

Fungsi ini digunakan untuk menghasilkan laporan keuangan berupa:

- **Saldo Awal Hutang** (sebelum periode)
- **DPP** (Dasar Pengenaan Pajak)
- **Discount**
- **PPN**
- **Pembayaran**
- **Saldo Akhir Hutang** (setelah mutasi)
...
- **Output**: `XLSX` file
- **Library**: [xlsxwriter](https://xlsxwriter.readthedocs.io/)
